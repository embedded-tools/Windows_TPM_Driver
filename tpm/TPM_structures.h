#ifndef TPM_STRUCTURES___H
#define TPM_STRUCTURES___H
...
#define TPM_TEMPORARY_LOCKED            0x80280803
#define TPM_COMMAND_BLOCKED             0x80280400
...
typedef struct tdTPM_PERMANENT_FLAGS {
  ...
  BOOL8 deactivated;
  BOOL8 readPubek;
  BOOL8 disableOwnerClear;
  BOOL8 allowMaintenance;
  BOOL8 physicalPresenceLifetimeLock;
  BOOL8 physicalPresenceHWEnable;
  BOOL8 physicalPresenceCMDEnable;
  BOOL8 CEKPUsed;
  BOOL8 TPMpost;
  BOOL8 TPMpostLock;
  BOOL8 FIPS;
  BOOL8 _operator;
  BOOL8 enableRevokeEK;
  BOOL8 nvLocked;
  BOOL8 readSRKPub;
  BOOL8 tpmEstablished;
  BOOL8 maintenanceDone;
  BOOL8 disableFullDALogicInfo;
  /* additional, not marshalled flags */
  BOOL8 selfTestSucceeded;
  BOOL8 owned;
  BOOL8 dataRestored;
} TPM_PERMANENT_FLAGS;
...
typedef struct tdTPM_STCLEAR_FLAGS {
  TPM_STRUCTURE_TAG tag;
  BOOL8 deactivated;
  BOOL8 disableForceClear;
  BOOL8 physicalPresence;
  BOOL8 physicalPresenceLock;
  BOOL8 bGlobalLock;
} TPM_STCLEAR_FLAGS;
...
typedef struct tdTPM_STANY_FLAGS {
  TPM_STRUCTURE_TAG tag;
  BOOL8 postInitialise;
  TPM_MODIFIER_INDICATOR localityModifier;
  BOOL8 transportExclusive;
  BOOL8 TOSPresent;
} TPM_STANY_FLAGS;
